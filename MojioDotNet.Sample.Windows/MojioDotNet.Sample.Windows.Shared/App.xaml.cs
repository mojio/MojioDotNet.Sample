...
namespace MojioDotNet.Sample.Windows
{
    ...
    public sealed partial class App : Application
    {
        ...
        protected override void OnActivated(IActivatedEventArgs args)
        {
            ...
            {
                var tokenBits = _WABContinuationArgs.WebAuthenticationResult.ResponseData;
                if (!string.IsNullOrEmpty(tokenBits))
                {
                    var rootFrame = (Window.Current.Content as Frame);
                    var mainPage = rootFrame.Content as MojioDotNet.Sample.Windows.MainPage;
                    (mainPage.DataContext as HomeViewModel).Manager.HandleTokenResponse(tokenBits);
                }
            }
